...
class TestHello(unittest.TestCase):
    ...
    def test_tan(self):
        self.assertAlmostEqual(hello.tan(0), 0)
        self.assertAlmostEqual(hello.tan(1), 1.5574077246549023)

    def test_cot(self):
        self.assertAlmostEqual(hello.cot(0), float("inf"))
        self.assertAlmostEqual(hello.cot(1), 0.6420926159343306)
